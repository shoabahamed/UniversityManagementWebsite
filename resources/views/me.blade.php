...
<body>
    ...
    <section class="container mt-4 mb-4">
      <h1 class="text-center mb-4" style="color: #006400">Mechanical Engineering</h1>
            ...
            <div id="hero-section" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner border border-success border-2 rounded">
                <div class="carousel-item active c-carousel-item" data-bs-interval="10000">
                  <img src="/assets/images/gallery/dept_gallery/me/1.jpg" class="d-block w-100  c-carousel-img" alt="...">
                </div>
                <div class="carousel-item c-carousel-item" data-bs-interval="2000">
                  <img src="/assets/images/gallery/dept_gallery/me/2.jpg" class="d-block w-100 c-carousel-img" alt="...">
                </div>
                <div class="carousel-item c-carousel-item">
                  <img src="/assets/images/gallery/dept_gallery/me/3.jpg" class="d-block w-100 c-carousel-img" alt="...">
                </div>
              </div>
