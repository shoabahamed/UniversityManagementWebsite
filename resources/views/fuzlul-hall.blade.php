...
<body>
    ...
    <div class="container my-4">
      ...
      <div class="row">
        <div class="col-md-8">
          <img src="https://www.kuet.ac.bd/images/FAZLUL.png" class="hall-picture border border-success border-2 rounded" alt="University Hall">
          <p>
        ...
        <div class="col-md-4">
          <div class="provost-info">
            <div class="card c-card">
              <img src="https://www.kuet.ac.bd/images/office/hall/md_elias_uddin.jpg" class="card-img-top" alt="Provost">
              <div class="card-body">
            ...
            <div class="card c-card mt-3">
              <img src="https://www.kuet.ac.bd/images/office/hall/md_elias_uddin.jpg" class="card-img-top" alt="Assistant Provost">
              <div class="card-body">
                <h5 class="card-title" style="color: #006400">Dr. Md. Elias Uddin</h5>
            ...
            <div class="card c-card mt-3">
              <img src="https://www.kuet.ac.bd/department/BECM/images/faculty/Ayan_Saha.jpg" class="card-img-top" alt="Assistant Provost">
              <div class="card-body">
