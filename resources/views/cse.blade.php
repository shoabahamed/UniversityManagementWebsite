      ...
      <div class="row welcome-section align-items-start justify-content-around">
            ...
            <div id="hero-section" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner border border-success border-2 rounded">
                <div class="carousel-item active c-carousel-item" data-bs-interval="10000">
                  <img src="https://www.kuet.ac.bd/department/CSE/images/slide/1_n.JPG" class="d-block w-100  c-carousel-img" alt="...">
                </div>
                <div class="carousel-item c-carousel-item" data-bs-interval="2000">
                  <img src="https://www.kuet.ac.bd/department/CSE/images/slide/2_n.JPG" class="d-block w-100 c-carousel-img" alt="...">
                </div>
                <div class="carousel-item c-carousel-item">
                  <img src="https://www.kuet.ac.bd/department/CSE/images/slide/3_n.JPG" class="d-block w-100 c-carousel-img" alt="...">
                </div>
              </div>
          ...
          <div class="col-md-4">
              <div class="vc-message">
                  <img src="https://www.kuet.ac.bd/department/CSE/images/head/cse.jpg" alt="VC">
                  <div class="vc-details">
                      <p class="vc-name">Dr. M. M. A. Hashem</p>
